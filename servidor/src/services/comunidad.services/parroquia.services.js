...
class ParroquiaService  { 
    ...
    async find() {
      const res = await models.Parroquia.findAll();   //--- nombre del models = models.Provincia
      return res;
    }
  ...
  module.exports = ParroquiaService;  //---- module.exports = exporta la Clase de Servicio 
