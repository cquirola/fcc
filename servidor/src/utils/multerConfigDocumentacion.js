...
// Directorio base para todos los archivos de documentaciones
const basePath = path.join(__dirname, '../uploads/comunidad/documentaciones');
...
const multerConfigDocumentacion = {
...
module.exports = multerConfigDocumentacion;
